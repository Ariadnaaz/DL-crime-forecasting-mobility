...
def calculate_performance_per_threhold(ref_city, crime_agg, seed):
    ...
    os.makedirs("perf_thrs", exist_ok=True) # create folder to save output if it does not exist
    output_path = f"perf_thrs/lr_perf_thrs_{ref_city}_{crime_agg}_{seed}.pkl"
